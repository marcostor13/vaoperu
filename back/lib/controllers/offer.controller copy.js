...
exports.del = exports.update = exports.getByProfileProviderId = exports.getByUserrId = exports.getByID = exports.get = exports.save = void 0;
...
exports.getByUserrId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    Collection.find({ userId: req.params.id }, (err, response) => {
        if (err) {
            res.status(501).json({
                message: `Error al obtener ${title}s`,
                data: null
...
//# sourceMappingURL=offer.controller copy.js.map