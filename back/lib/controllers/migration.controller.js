1464,1465,1466,1467,1469,1471,1478,1482,1483,1516,1517,1518,1520,1527,1545,1546,1549,1550,1551,1553,1555,1556,1559,1560,1561,1565,1566,1567,1568,1569,1570,1571,1572,1573,1574,1575,1576,1577,1578,1579,1580,1581,1583,1588,1590,1591,1592,1593,1594,1595,1596,1597,1598,1599,1600,1601,1602,1603,1604,1605,1606,1607,1608,1611,1612,1613,1614,1615,1616,1617,1618,1619,1620,1621,1622,1623,1624,1625,1626,1627,1630,1632,1633,1634,1635,1636,1637,1638,1640,1641,1642,1643,1644,1645,1646,1647,1648,1649,1650,1652,1653,1654,1656,1657,1659,1661,1662,1663,1664,1665,1666,1670,1671,1672,1673,1674,1676,1677,1678,1680,1681,1682,1683,1684,1685,1689,1690,1691,1692,1694,1695,1696,1697,1700,1704,1707,1708,1709,1710,1711,1714,1715,1716,1717,1719,1726,1729,1730,1731,1732,1733,1734,1735,1736,1737,1738,1739,1740,1743,1744,1745,1746,1747,1748,1751,1752,1753,1754,1755,1756,1757,1758,1759,1760,1761,1762,1763,1764,1765,1766,1768,1769,1770,1771,1773,1774,1776)"
    try {
        const query = `
            SELECT DISTINCT 
            users.name as name, 
        ...
        const userDatas = (yield exports.execute(query));
        if (userDatas) {
            userDatas.forEach((userData) => __awaiter(void 0, void 0, void 0, function* () {
                var _a;
                const resp = userData;
                const body = {
                ...
                if (!user) {
                    ...
                    const district = districts.find(d => { var _a, _b; return ((_a = d === null || d === void 0 ? void 0 : d.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().trim()) === ((_b = resp === null || resp === void 0 ? void 0 : resp.district) === null || _b === void 0 ? void 0 : _b.toLowerCase().trim()); });
                    let districtId = '';
                    let districtName = '';
                    if (district) {
                    ...
                    //SAVE URL
                    const urlData = {
                        url: (_a = resp === null || resp === void 0 ? void 0 : resp.url) === null || _a === void 0 ? void 0 : _a.toLowerCase().trim(),
                    ...
                    categoriesCompanyData.forEach((c) => __awaiter(void 0, void 0, void 0, function* () {
                        const itemSearch = items.find(item => { var _a, _b; return ((_a = item === null || item === void 0 ? void 0 : item.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().trim()) === ((_b = c === null || c === void 0 ? void 0 : c.categoryName) === null || _b === void 0 ? void 0 : _b.toLowerCase().trim()); });
                        if (itemSearch) {
                            const CSPData = {
                    ...
                    subcategoriesCompanyData.forEach((s) => __awaiter(void 0, void 0, void 0, function* () {
                        const subitemSearch = subitems.find(subitem => { var _a, _b; return ((_a = subitem === null || subitem === void 0 ? void 0 : subitem.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().trim()) === ((_b = s === null || s === void 0 ? void 0 : s.subcategoryName) === null || _b === void 0 ? void 0 : _b.toLowerCase().trim()); });
                        if (subitemSearch) {
                            const CSPData = {
